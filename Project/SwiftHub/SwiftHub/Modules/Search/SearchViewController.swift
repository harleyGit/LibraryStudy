...
class SearchViewController: TableViewController {
    ...
    //Daily, Weekly, Monthly的SegmentedControl的父View
    ...
    override func makeUI() {
        ...
        themeService.attrsStream.subscribe(onNext: { [weak self] (theme) in
            ...
            self?.searchModeSegmentedControl.sectionImages = [
                //tint(_ color: UIColor, blendMode: CGBlendMode, alpha: CGFloat = 1.0)： 给图片着色
                //withRoundedCorners： 图片切成圆角
